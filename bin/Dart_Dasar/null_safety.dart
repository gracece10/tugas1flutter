...
//Default Value
  ...
  //Pakai Default Value
  //guest = 'Oscarissa'; //bakal tampil warning karena dart tau value nya sudah kita set di bagian ini String guestName = guest ?? 'Grace';
  String guestName = guest ?? 'Grace'; // String guestName = guest ??;

  //Pakai Ternary
  //String guestName = guest != null ? guest : 'Grace';
